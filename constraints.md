...
- SR preference constraints and bonuses:
  ...
  - Chosen SR is forbidden outside career blocks 19–30; if no historical SR in blocks 19–24, the chosen SR must fall in blocks 25–30 (when such blocks exist). If no 19–30 blocks exist in the current AY (e.g., stage 1 resident), a chosen SR is still required and is banned from assignment this year; window bonuses are skipped.
